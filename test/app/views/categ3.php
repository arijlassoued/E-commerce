								...
								<div class="product product-single">
									<div class="product-thumb">
										<div class="product-label">
											<span>New</span>
											<span class="sale"><?php echo $prod->promo ?>%</span>
										</div>
									...
									<div class="product-body">
										<h3 class="product-price"><?php echo $prod->prix ?>$ <del class="product-old-price"><?php echo (($prod->prix)*($prod->promo)/100) ?>$</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
