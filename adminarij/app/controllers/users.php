...
class users extends Controller {
    ...
    public function register() {
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            } elseif (!preg_match($nameValidation, $data['adminname'])) {
            ...
            if (empty($data['nameError']) && empty($data['passwordError']) && empty($data['confirmPasswordError'])) {
    ...
    public function forgot_passwword() {
